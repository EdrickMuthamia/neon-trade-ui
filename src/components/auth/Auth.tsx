  ...
  return (
    <div className="min-h-screen bg-[#0f1115] flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-blue-900/20 to-black p-12 flex-col justify-between relative overflow-hidden">
        <div className="absolute inset-0 bg-[url('https://storage.googleapis.com/dala-prod-public-storage/generated-images/bfee534d-a4af-4382-8c2c-a6f6c3e9e27b/market-bg-6c7cb3f8-1775677920032.webp')] opacity-20 bg-cover bg-center" />
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-3xl font-black text-white italic tracking-tighter">DTTOOL</h1>
          </div>
          <motion.div
        ...
        <div className="relative z-10 grid grid-cols-2 gap-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h4 className="font-bold text-white">Nano-Second Execution</h4>
              <p className="text-sm text-gray-500">Trade at the speed of light.</p>
            </div>
          </div>
        </div>
      </div>
